...
def tax_expert_agent(query: str, top_k: int = 5) -> str:
    """
    1️⃣ Creates embedding for the query
    2️⃣ Performs hybrid retrieval from Azure AI Search
    3️⃣ Uses GPT-4o-mini to rerank and synthesize an answer
    """
...
response = tax_expert_agent("how many transfer pricing documents are there in your knwoledge repository? Are you sure there are only two documents? ")
print(response)