...
# 1) Check key package versions
import sys, inspect, transformers, torch, ray
print("Python:", sys.version)
print("transformers:", transformers.__version__)
print("torch:", torch.__version__)
print("ray:", ray.__version__)

# 2) Inspect TrainingArguments parameters to confirm which key is expected
from transformers import TrainingArguments
params = inspect.signature(TrainingArguments.__init__).parameters
print("expects eval_strategy:", "eval_strategy" in params)
print("expects evaluation_strategy:", "evaluation_strategy" in params)
...
# MAGIC
# MAGIC %sh python -V
# MAGIC %sh pip show transformers accelerate datasets trl peft ray | sed 's/^/  /'
# MAGIC
...
# MAGIC %pip install --upgrade ray[tune]==2.53.0
# MAGIC dbutils.library.restartPython()
# MAGIC
...
# In Prod notebook
%pip install "transformers==4.50.2" --upgrade
dbutils.library.restartPython()  # or %restart_python
...
# "4.45.2" → ✅ evaluation_strategy works
# "4.46.0" or "4.52.6" → ❌ must use eval_strategy
...
# 2. Config
# ================================================================
DATA_DIR = "/dbfs/tmp/training_data/synthetic_tax_pure_encoderv10/pairs"
BASE_MODEL = "/dbfs/tmp/model_dir/bge_m3/tax_multilabel_classification_finetunedv1"
# BASE_MODEL = "/dbfs/tmp/model_dir/bge_m3/base_v1"
MODEL_OUT  = "/dbfs/tmp/model_dir/bge_m3/tax_multilabel_classification_finetunedv1"
FULL_MODEL_OUT = "/dbfs/tmp/model_dir/bge_m3/tax_multilabel_classification_finetunedv1"
...
class SemanticDualEncoderTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False, **kwargs):
        ...
        # --- Gradient guards ---
        # doc_emb.requires_grad checks if the doc_emb tensor requires gradients. If it does not, the assertion fails and the message "doc_emb detached / no_grad" is printed. This is to ensure that the doc_emb tensor is not detached from the computation graph and can be used for backpropagation.
        ...
        # cos.requires_grad checks if the cos tensor requires gradients. If it does not, the assertion fails and the message "cos lost grad" is printed. This is to ensure that the cos tensor is also part of the computation graph and its gradients can be computed during backpropagation.
...
analysis = tune.run(
    ...
    scheduler=pbt,
    num_samples=2, # training will run for 2 trials. Each trial will train the model for 2 epochs with batch_size of 16 as mentioned in the MEDIUM_CONFIG as batch_size
...
os.makedirs(FULL_MODEL_OUT, exist_ok=True)
...
path = "/local_disk0/tmp/ray/session_2026-02-19_19-21-42_296439_3534/artifacts/2026-02-19_19-21-45/dual_encoder_pbt/driver_artifacts/train_with_pbt_3abe8_00000_0_2026-02-19_19-21-45/error.txt"
...
import pytz
files = dbutils.fs.ls("dbfs:/tmp/model_dir/bge_m3/tax_multilabel_classification_finetunedv1")
rows = []
for f in files:
...
# ------------------------------
MODEL_PATH = "/dbfs/tmp/model_dir/bge_m3/tax_multilabel_classification_finetunedv1"
