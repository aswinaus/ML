...
# MODEL_PATH="abfss://model@eymydocsmladls.dfs.core.windows.net/classifier_model"
...
- Tax similarity depends on embedding strength, not keyword match  
- Not designed to detect image-based PII  

## **Contacts**
- Owner: Aswin Bhaskaran  
- Created by: aswinbhaskaran@hexaware.com
"""
...
#     transformers_model=MODEL_PATH,        # path to local trainer model directory
#     artifact_path="dual_encoder_serving", # name for the logged artifact
#     registered_model_name="DocsKHClassifier", # registry name
...
with mlflow.start_run():
    ...
    mlflow.pyfunc.log_model(
        artifact_path="document_classification_serving",
        python_model=DualEncoderServingModel(),
        artifacts={"model_dir": MODEL_PATH},
        registered_model_name="DocsClassificationModel",
